...
function runBaseTests() {
  px_action_sheet_1 = document.getElementById('px_action_sheet_1');

  suite('Base Automation Tests for px-action-sheet', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-action-sheet fixture is created', function() {
      assert.isTrue(document.getElementById('px_action_sheet_1') !== null);
    });
